...
const VerifyEmail = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary via-primary to-secondary p-6 relative overflow-hidden">
      ...
      <div className="bg-slate-800 rounded-xl shadow-2xl p-8 w-full max-w-lg relative z-10 animate-slide-up text-center border border-slate-700">
          ...
          <div className="py-8">
            {verifying ? (
              <div className="flex flex-col items-center gap-4 p-6">
                ...
                <p className="text-slate-300">Verifying...</p>
              </div>
            ) : verified ? (
